...
prod:
	...
	sudo docker compose -f compose.prod.yaml exec app bin/console make:migration --no-interaction
...
prod-first-time:
	...
	sudo docker compose -f compose.prod.yaml exec app composer install --optimize-autoloader
	sudo docker compose -f compose.prod.yaml exec app bin/console make:migration --no-interaction
	sudo docker compose -f compose.prod.yaml exec app bin/console doctrine:database:create --no-interaction
	sudo docker compose -f compose.prod.yaml exec app bin/console doctrine:migrations:migrate --no-interaction
